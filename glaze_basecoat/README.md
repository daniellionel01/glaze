...
|-----------|--------|---------------|
| Accordion | Planned | [Basecoat](https://basecoatui.com/components/accordion) |
| Alert | ✅ | [Basecoat](https://basecoatui.com/components/alert) |
| Alert Dialog | Planned | [Basecoat](https://basecoatui.com/components/alert-dialog) |
| Avatar | ✅ | [Basecoat](https://basecoatui.com/components/avatar) |
| Badge | ✅ | [Basecoat](https://basecoatui.com/components/badge) |
| Breadcrumb | Planned | [Basecoat](https://basecoatui.com/components/breadcrumb) |
...
| Checkbox | Planned | [Basecoat](https://basecoatui.com/components/checkbox) |
| Command | Planned | [Basecoat](https://basecoatui.com/components/command) |
| Combobox | Planned | [Basecoat](https://basecoatui.com/components/combobox) |
| Dialog | Planned | [Basecoat](https://basecoatui.com/components/dialog) |
| Dropdown Menu | Planned | [Basecoat](https://basecoatui.com/components/dropdown-menu) |
| Empty | Planned | [Basecoat](https://basecoatui.com/components/empty) |
| Field | Planned | [Basecoat](https://basecoatui.com/components/field) |
| Form | Planned | [Basecoat](https://basecoatui.com/components/form) |
| Input | Planned | [Basecoat](https://basecoatui.com/components/input) |
| Input Group | Planned | [Basecoat](https://basecoatui.com/components/input-group) |
| Item | Planned | [Basecoat](https://basecoatui.com/components/item) |
| Kbd | ✅ | [Basecoat](https://basecoatui.com/components/kbd) |
| Label | ✅ | [Basecoat](https://basecoatui.com/components/label) |
| Pagination | Planned | [Basecoat](https://basecoatui.com/components/pagination) |
| Popover | Planned | [Basecoat](https://basecoatui.com/components/popover) |
| Progress | ✅ | [Basecoat](https://basecoatui.com/components/progress) |
| Radio Group | Planned | [Basecoat](https://basecoatui.com/components/radio-group) |
| Select | Planned | [Basecoat](https://basecoatui.com/components/select) |
| Sidebar | Planned | [Basecoat](https://basecoatui.com/components/sidebar) |
| Skeleton | ✅ | [Basecoat](https://basecoatui.com/components/skeleton) |
| Slider | Planned | [Basecoat](https://basecoatui.com/components/slider) |
| Spinner | ✅ | [Basecoat](https://basecoatui.com/components/spinner) |
| Switch | Planned | [Basecoat](https://basecoatui.com/components/switch) |
| Table | Planned | [Basecoat](https://basecoatui.com/components/table) |
| Tabs | Planned | [Basecoat](https://basecoatui.com/components/tabs) |
| Textarea | Planned | [Basecoat](https://basecoatui.com/components/textarea) |
| Theme Switcher | Planned | [Basecoat](https://basecoatui.com/components/theme-switcher) |
| Toast | Planned | [Basecoat](https://basecoatui.com/components/toast) |
| Tooltip | Planned | [Basecoat](https://basecoatui.com/components/tooltip) |
...
let custom_theme =
  theme.default_theme()
  |> theme.set(theme.Primary, "222.2 47.4% 11.2%")
