...
Framework-agnostic in this case means that they are not tied to a particular JavaScript Framework ([React](https://react.dev/), [Vue](https://vuejs.org/), [Svelte](https://svelte.dev/), ...). They are "purely" CSS and vanilla JavaScript.
